...
description: "When working with a database it is common to request data that is spread across multiple tables. To retrieve data from two different tables we can use either... (VB)"
ms.author: riande
ms.date: 07/18/2007
...
[![Screenshot showing the TableAdaptor Configuration Wizard window with a query entered that contains JOINs.](updating-the-tableadapter-to-use-joins-vb/_static/image2.png)](updating-the-tableadapter-to-use-joins-vb/_static/image1.png)
...
![Screenshot showing the Advanced Options window with the Generate Insert, Update and Delete statements checkbox selected.](updating-the-tableadapter-to-use-joins-vb/_static/image4.png)
...
This tutorial series was reviewed by many helpful reviewers. Lead reviewers for this tutorial were Hilton Geisenow, David Suru, and Teresa Murphy. Interested in reviewing my upcoming MSDN articles? If so, drop me a line at mitchell@4GuysFromRolla.com.
