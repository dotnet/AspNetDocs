...
description: "An ASP.NET application typically stores configuration information in a Web.config file. Some of this information is sensitive and warrants protection. By def... (C#)"
ms.author: riande
ms.date: 08/03/2007
...
[![Screenshot showing Visual Studio opened to the EncryptingConfigSections.aspx page, which has a new TextBox and two Button controls.](protecting-connection-strings-and-other-configuration-information-cs/_static/image5.png)](protecting-connection-strings-and-other-configuration-information-cs/_static/image4.png)
...
[![Screenshot showing the EncryptingConfigSections.aspx page loaded in a web browser.](protecting-connection-strings-and-other-configuration-information-cs/_static/image8.png)](protecting-connection-strings-and-other-configuration-information-cs/_static/image7.png)
