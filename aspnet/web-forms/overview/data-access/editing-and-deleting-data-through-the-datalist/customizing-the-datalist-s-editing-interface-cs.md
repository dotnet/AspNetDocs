...
description: "In this tutorial we will create a richer editing interface for the DataList, one that includes DropDownLists and a CheckBox. (C#)"
ms.author: riande
ms.date: 10/30/2006
...
[![Screenshot showing the DataList EditItemTemplate after the EditCommand and CancelCommand event handlers have been added and the Edit button has been selected.](customizing-the-datalist-s-editing-interface-cs/_static/image23.png)](customizing-the-datalist-s-editing-interface-cs/_static/image22.png)
...
[![Screenshot showing the DataList EditItemTemplate after the DataBinding syntax has been added and the Edit button has been selected.](customizing-the-datalist-s-editing-interface-cs/_static/image26.png)](customizing-the-datalist-s-editing-interface-cs/_static/image25.png)
