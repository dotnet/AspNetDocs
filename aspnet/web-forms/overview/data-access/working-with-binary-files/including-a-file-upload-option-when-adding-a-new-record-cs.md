...
description: "This tutorial shows how to create a Web interface that allows the user to both enter text data and upload binary files. To illustrate the options available t... (C#)"
ms.author: wpickett
ms.date: 03/27/2007
...
[Download PDF](including-a-file-upload-option-when-adding-a-new-record-cs/_static/datatutorial56cs1.pdf)
...
[![Screenshot showing DetailsView open with the CategoryID property set to NewCategory, empty Height and Width property values and the Enable Inserting checkbox selected.](including-a-file-upload-option-when-adding-a-new-record-cs/_static/image6.gif)](including-a-file-upload-option-when-adding-a-new-record-cs/_static/image11.png)
...
![Screenshot of the fields window with TemplateField, Picture, and HeaderText highlighted.](including-a-file-upload-option-when-adding-a-new-record-cs/_static/image7.gif)
...
This tutorial series was reviewed by many helpful reviewers. Lead reviewers for this tutorial were Dave Gardner, Teresa Murphy, and Bernadette Leigh. Interested in reviewing my upcoming MSDN articles? If so, drop me a line at mitchell@4GuysFromRolla.com.
