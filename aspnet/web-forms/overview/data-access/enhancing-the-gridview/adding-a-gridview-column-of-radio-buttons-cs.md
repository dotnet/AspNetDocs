...
description: "This tutorial looks at how to add a column of radio buttons to a GridView control to provide the user with a more intuitive way of selecting a single row of... (C#)"
ms.author: riande
ms.date: 03/06/2007
...
[Download PDF](adding-a-gridview-column-of-radio-buttons-cs/_static/datatutorial51cs1.pdf)
...
[![Screenshot of the Configure Data Source - SuppliersDataSource window with the business object SuppliersBLL selected and the Next button highlighted.](adding-a-gridview-column-of-radio-buttons-cs/_static/image5.gif)](adding-a-gridview-column-of-radio-buttons-cs/_static/image5.png)
...
[![Screenshot of the Configure Data Source - SuppliersDataSource window with the SELECT tab open. The method option GetSupplierByCountry is selected and the Next button is highlighted.](adding-a-gridview-column-of-radio-buttons-cs/_static/image6.gif)](adding-a-gridview-column-of-radio-buttons-cs/_static/image7.png)
...
[![Screenshot of the Configure Data Source - SuppliersDataSource window with the UPDATE tab open. The method option (None) is selected and the Next button is highlighted.](adding-a-gridview-column-of-radio-buttons-cs/_static/image7.gif)](adding-a-gridview-column-of-radio-buttons-cs/_static/image9.png)
