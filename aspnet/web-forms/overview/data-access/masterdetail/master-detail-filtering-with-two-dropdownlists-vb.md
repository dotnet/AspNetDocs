...
[![Screenshot of the Configure Data Source - productsByCategoryDataSource window displaying the business object dropdown menu with ProductsBLL selected and the Next button highlighted.](master-detail-filtering-with-two-dropdownlists-vb/_static/image23.png)](master-detail-filtering-with-two-dropdownlists-vb/_static/image22.png)
...
[![Screenshot of the Configure Data Source - productsByCategoryDataSource window with the business object dropdown menu open. ProductsBLL is selected and the Next button is highlighted.](master-detail-filtering-with-two-dropdownlists-vb/_static/image44.png)](master-detail-filtering-with-two-dropdownlists-vb/_static/image43.png)
