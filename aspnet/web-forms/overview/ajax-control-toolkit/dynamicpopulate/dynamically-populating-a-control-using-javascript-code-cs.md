...
author: wenz
description: "The DynamicPopulate control in the ASP.NET AJAX Control Toolkit calls a web service (or page method). It fills the resulting value into a target control on t... (C#)"
ms.author: riande
ms.date: 06/02/2008
