...
2. In Solution Explorer, open the **Site.css** file located under the **Styles** folder. Make sure the **Text Editor** tools are visible on the toolbar. To do that, select the **View** | **Toolbars** menu option, and check the **Text Editor** options. You will notice that, since this new version, the **Comment** button (:::image type="icon" source="whats-new-in-aspnet-and-web-development-in-visual-stuido-2012/_static/image1.png":::) and the **Uncomment** button (:::image type="icon" source="whats-new-in-aspnet-and-web-development-in-visual-stuido-2012/_static/image2.png":::) are also enabled for the CSS editor.
