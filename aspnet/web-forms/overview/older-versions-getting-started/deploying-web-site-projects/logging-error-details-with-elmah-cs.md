...
description: "Error Logging Modules And Handlers (ELMAH) offers another approach to logging runtime errors in a production environment. ELMAH is a free, open source error... (C#)"
ms.author: riande
ms.date: 06/09/2009
...
[![Screenshot that shows that remote visitors can't view the error log web page.](logging-error-details-with-elmah-cs/_static/image15.png)](logging-error-details-with-elmah-cs/_static/image14.png)
