...
description: "Visual Studio offers ASP.NET developers two types of projects: Web Application Projects (WAPs) and Web Site Projects (WSPs). One of the key differences betwe... (VB)"
ms.author: riande
ms.date: 06/09/2009
...
/previous-versions/aspnet/bb398860(v=vs.100)