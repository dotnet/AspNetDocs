...
- [Examining ASP.NET 2.0s Membership, Roles, and Profile](/aspnet/web-forms/overview/older-versions-security/roles/creating-and-managing-roles-vb)
...
- [Working Directly with the `SqlMembershipProvider`](/dotnet/api/system.web.security.sqlmembershipprovider)
