...
author: bradygaster
description: Describes the Introduction to SignalR Security application and provides an overview, tables, and exceptions.
ms.author: bradyg
ms.date: 10/17/2013
...
![Diagram Connection Token system, showing the relationship between the Client, Server, Authentication System, and Connection Token.](introduction-to-security/_static/image2.png)
...
![Diagram of the Connection Token system, showing the relationship between the Client, Server, and Saved Token.](introduction-to-security/_static/image4.png)
