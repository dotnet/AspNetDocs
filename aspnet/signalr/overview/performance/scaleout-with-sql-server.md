...
![An image with arrows that go from SQL Server to VMs to computers. One arrow labeled "Update" starts at VMs and goes to SQL Server.](scaleout-with-sql-server/_static/image1.png)
...
![Window titled 'Object Explorer'. The folder 'Databases' is selected.](scaleout-with-sql-server/_static/image2.png)
...
![Window displaying the sys.databases catalog view.](scaleout-with-sql-server/_static/image3.png)
...
![Window titled 'Add Roles and Features Wizard'. On the 'Server Roles' option, 'WebSocket Protocol' is selected.](scaleout-with-sql-server/_static/image4.png)
...
![Window titled 'Add Roles and Features Wizard'. On the 'Server Roles' option, 'Management Service' is selected.](scaleout-with-sql-server/_static/image6.png)
...
![Two browser windows open.](scaleout-with-sql-server/_static/image7.png)

After you run the application, you can see that SignalR has automatically created tables in the database:

![Window titled 'Object Explorer' displaying folders and files.](scaleout-with-sql-server/_static/image8.png)
