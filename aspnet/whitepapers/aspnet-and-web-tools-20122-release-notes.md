...
3. Verify the version of Visual Studio you will update. You can do this by launching the Visual Studio you wish to update. Then click the Help menu item.   
    ![Screenshot that shows the Help dropdown menu. About Microsoft Visual Studio Express 2012 for Web is circled in red.](aspnet-and-web-tools-20122-release-notes/_static/image1.jpg)
