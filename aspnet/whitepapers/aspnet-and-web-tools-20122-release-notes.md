...
3. Verify the version of Visual Studio you will update. You can do this by launching the Visual Studio you wish to update. Then click the Help menu item.   
    ![Screenshot of the Visual Studio Express 2012 for Web help menu. The menu entry titled 'About Microsoft Visual Studio Express 2012 for Web' is highlighted.](aspnet-and-web-tools-20122-release-notes/_static/image1.jpg)
...
![A screenshot of the Visual Studio error message that may appear when creating an MVC 4 project.](aspnet-and-web-tools-20122-release-notes/_static/image1.png)
