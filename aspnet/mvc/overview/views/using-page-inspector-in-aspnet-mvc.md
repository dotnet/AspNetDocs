...
> [!NOTE]
> To get the latest version of Page Inspector, use [Web Platform Installer](/iis/install/web-platform-installer/web-platform-installer-direct-downloads) to install the Windows Azure SDK for .NET 2.0.
