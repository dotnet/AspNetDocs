...
![Screenshot that shows the M V C Movie App browser window on the My Movie List page.](accessing-your-models-data-from-a-controller/_static/image5.png)

### Creating a Movie

Select the **Create New** link. Enter some details about a movie and then click the **Create** button.

![Screenshot that shows the M V C Movie App browser window on the Create page.](accessing-your-models-data-from-a-controller/_static/image6.png)
...
> [!NOTE]
> If you get an error when you double-click *Movies.sdf*, make sure you've installed [SQL Server Compact 4.0](https://www.microsoft.com/en-US/download/details.aspx?id=30709)(runtime + tools support). (For links to the software, see the list of prerequisites in part 1 of this tutorial series.) If you install the release now, you'll have to close and re-open Visual Web Developer.
