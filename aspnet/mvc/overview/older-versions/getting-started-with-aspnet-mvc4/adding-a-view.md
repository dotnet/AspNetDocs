...
description: "In this section you're going to modify the HelloWorldController class to use view template files to cleanly encapsulate the process of generating HTML responses to a client."
ms.author: riande
ms.date: 08/28/2012
...
![Screenshot that shows the Solution Explorer. Index dot c s h t m l is selected in the Hello World sub folder.](adding-a-view/_static/image3.png)
...
![Screenshot that shows the Add View dialog box. Welcome is in the View name field.](adding-a-view/_static/image11.png)
