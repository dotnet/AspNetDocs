...
description: "In this section, you'll examine the generated action methods and views for the movie controller. Then you'll add a custom search page."
ms.author: riande
ms.date: 05/09/2022
...
<<<<<<< HEAD
<<<<<<< HEAD
![Screenshot that shows the M V C Movie Search Index page.](examining-the-edit-methods-and-edit-view/_static/image8.png)
=======
...
<<<<<<< HEAD
<<<<<<< HEAD
![Screenshot that shows the M V C Movie Search Index page. The Genre is set to All.](examining-the-edit-methods-and-edit-view/_static/image12.png)
=======
