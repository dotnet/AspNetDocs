...
![Screenshot of the Contoso University Web Application screens you'll create.](creating-an-entity-framework-data-model-for-an-asp-net-mvc-application/_static/image2.png)
...
1. In the Package Manager Console window, enter the following commands: 
    ...
    ![Screenshot of the Package Manager Console window.](creating-an-entity-framework-data-model-for-an-asp-net-mvc-application/_static/image13.png)
...
2. Click the **Add Connection** icon.
    ...
    ![Screenshot of the Server Explorer which is called the Database Explorer in Visual Studio Express 2012 for Web.](creating-an-entity-framework-data-model-for-an-asp-net-mvc-application/_static/image15.png)

3. If you are prompted with the **Choose Data Source** dialog, click **Microsoft SQL Server**, and then click **Continue**.  
  
    ![Screenshot of the Choose Data Source dialog.](creating-an-entity-framework-data-model-for-an-asp-net-mvc-application/_static/image16.png)
...
4. In the **Add Connection** dialog box, enter **(localdb)\v11.0** for the **Server Name**. Under **Select or enter a database name**, select **ContosoUniversity.**  
    ...
    ![Screenshot of the Add Connection dialog.](creating-an-entity-framework-data-model-for-an-asp-net-mvc-application/_static/image17.png)

5. Click **OK.**
6. Expand **SchoolContext** and then expand **Tables**.  
  
    ![Screenshot of the Server Explorer to expand School Context and then expand Tables.](creating-an-entity-framework-data-model-for-an-asp-net-mvc-application/_static/image18.png)
