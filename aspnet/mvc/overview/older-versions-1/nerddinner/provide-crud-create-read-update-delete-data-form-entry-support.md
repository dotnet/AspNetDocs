...
:::image type="content" source="provide-crud-create-read-update-delete-data-form-entry-support/_static/image1.png" alt-text="Screenshot of creating a view template to add view in Visual Studio.":::
...
:::image type="content" source="provide-crud-create-read-update-delete-data-form-entry-support/_static/image2.png" alt-text="Screenshot of Add view to auto-scaffold an Edit template.":::
...
:::image type="content" source="provide-crud-create-read-update-delete-data-form-entry-support/_static/image3.png" alt-text="Screenshot of new Edit view template within the code-editor.":::
...
:::image type="content" source="provide-crud-create-read-update-delete-data-form-entry-support/_static/image4.png" alt-text="Screenshot of My M V C Application page.":::
...
:::image type="content" source="provide-crud-create-read-update-delete-data-form-entry-support/_static/image5.png" alt-text="Screenshot of the generated H T M L markup.":::
...
:::image type="content" source="provide-crud-create-read-update-delete-data-form-entry-support/_static/image6.png" alt-text="Screenshot of H T M L output when user requests an Edit Dinner.":::
...
:::image type="content" source="provide-crud-create-read-update-delete-data-form-entry-support/_static/image7.png" alt-text="Screenshot of the Edit Dinner page.":::
...
:::image type="content" source="provide-crud-create-read-update-delete-data-form-entry-support/_static/image8.png" alt-text="Screenshot of the details URL for the Dinner.":::
...
:::image type="content" source="provide-crud-create-read-update-delete-data-form-entry-support/_static/image10.png" alt-text="Screenshot of the highlighted invalid input elements.":::
...
:::image type="content" source="provide-crud-create-read-update-delete-data-form-entry-support/_static/image11.png" alt-text="Screenshot of the list of all detailed error messages in the ModelState collection.":::
...
:::image type="content" source="provide-crud-create-read-update-delete-data-form-entry-support/_static/image12.png" alt-text="Screenshot of Add view to create a view template.":::
...
:::image type="content" source="provide-crud-create-read-update-delete-data-form-entry-support/_static/image13.png" alt-text="Screenshot of the I D E to edit the code.":::
...
:::image type="content" source="provide-crud-create-read-update-delete-data-form-entry-support/_static/image14.png" alt-text="Screenshot of Create action implementation when we run our application and access the Dinners U R L.":::
...
:::image type="content" source="provide-crud-create-read-update-delete-data-form-entry-support/_static/image15.png" alt-text="Screenshot of the form redisplayed with errors highlighted.":::
...
:::image type="content" source="provide-crud-create-read-update-delete-data-form-entry-support/_static/image16.png" alt-text="Screenshot of the newly created Dinner.":::
...
:::image type="content" source="provide-crud-create-read-update-delete-data-form-entry-support/_static/image17.png" alt-text="Screenshot of creating the Delete view template as an an empty template.":::
...
:::image type="content" source="provide-crud-create-read-update-delete-data-form-entry-support/_static/image18.png" alt-text="Screenshot of the Dinner delete confirmation U I in the H T T P G E T Delete action method.":::
...
:::image type="content" source="provide-crud-create-read-update-delete-data-form-entry-support/_static/image19.png" alt-text="Screenshot of the Dinner delete confirmation screen in the H T T P P O S T Delete action method.":::
...
:::image type="content" source="provide-crud-create-read-update-delete-data-form-entry-support/_static/image20.png" alt-text="Screenshot of the Deleted view template.":::
