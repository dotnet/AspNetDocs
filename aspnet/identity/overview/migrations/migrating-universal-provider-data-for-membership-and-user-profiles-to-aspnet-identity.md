...
1. Create a new ASP.NET 4.5 Web Forms application in Visual Studio 2012. The current sample uses the Web Forms template, but you could use MVC Application as well.  
    ...
    :::image type="content" source="migrating-universal-provider-data-for-membership-and-user-profiles-to-aspnet-identity/_static/image1.jpg" alt-text="Screenshot of a newly created Web Forms application in Visual Studio 2012 using the Web Forms template.":::

1. Create a new folder 'Models' to store profile information  

    :::image type="content" source="migrating-universal-provider-data-for-membership-and-user-profiles-to-aspnet-identity/_static/image1.png" alt-text="Screenshot of the new folder called Models created to store profile information.":::
...
6. Run the app and create a new user with username '**olduser'.** Navigate to the 'AddProfileData' page and add profile information for the user.  
    ...
    :::image type="content" source="migrating-universal-provider-data-for-membership-and-user-profiles-to-aspnet-identity/_static/image2.png" alt-text="Screenshot of the Add Profile Data page to add profile information for the user.":::
...
:::image type="content" source="migrating-universal-provider-data-for-membership-and-user-profiles-to-aspnet-identity/_static/image3.png" alt-text="Screenshot of the Server Explorer window that shows the data stored in the 'Profiles' table.":::

:::image type="content" source="migrating-universal-provider-data-for-membership-and-user-profiles-to-aspnet-identity/_static/image4.png" alt-text="Screenshot of the Profiles data table.":::
...
:::image type="content" source="migrating-universal-provider-data-for-membership-and-user-profiles-to-aspnet-identity/_static/image5.png" alt-text="Screenshot of updating the schema in the Identity database by selecting New Query.":::
...
:::image type="content" source="migrating-universal-provider-data-for-membership-and-user-profiles-to-aspnet-identity/_static/image6.png" alt-text="Screenshot of the Default Connection refreshed and new tables added.":::
...
1. Install the Nuget packages needed for ASP.NET Identity:
   ...
   More information on managing Nuget packages can be found [here](https://docs.nuget.org/docs/start-here/Managing-NuGet-Packages-Using-The-Dialog)
...
1. Create a new console application in the exiting solution.  
    ...
    :::image type="content" source="migrating-universal-provider-data-for-membership-and-user-profiles-to-aspnet-identity/_static/image2.jpg" alt-text="Screenshot of creating a new console application in the exiting solution.":::
...
6. Open a command prompt and navigate to the bin folder of the above console application. Run the executable and review the log output as shown in the following image.  
    ...
    :::image type="content" source="migrating-universal-provider-data-for-membership-and-user-profiles-to-aspnet-identity/_static/image3.jpg" alt-text="Screenshot of the executable in the command prompt to run and review the log output.":::
